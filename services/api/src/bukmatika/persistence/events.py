...
class SemanticEventType(StrEnum):
    ...
    ACQUISITION_REQUEST_CREATED = "acquisition.request_created"
    ACQUISITION_REQUEST_APPROVED = "acquisition.request_approved"
    ACQUISITION_REQUEST_CANCELLED = "acquisition.request_cancelled"
    ...
    RESEARCH_SEMANTIC_SEARCH_COMPLETED = "research.semantic_search_completed"
    RESEARCH_COMPARISON_COMPLETED = "research.comparison_completed"
    ...
    AI_DELEGATION_PROPOSED = "ai.delegation_proposed"
    AI_DELEGATION_DECIDED = "ai.delegation_decided"
    AI_DELEGATION_STARTED = "ai.delegation_started"
    AI_DELEGATION_DISPATCH_QUEUED = "ai.delegation_dispatch_queued"
    AI_DELEGATION_DISPATCH_FAILED = "ai.delegation_dispatch_failed"
    ...
    HIGHLIGHT_ADDED = "reader.highlight_added"
    HIGHLIGHT_NOTE_UPDATED = "reader.highlight_note_updated"
    HIGHLIGHT_REMOVED = "reader.highlight_removed"
